...
public class CouponController {
    ...
    public ResponseEntity<Iterable<CouponDTO>> getCouponsForRestaurant(@ModelAttribute("currentUser") User user, @ModelAttribute("restaurant") Restaurant restaurant) {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("@resourceGuard.checkOwnership(#user, #restaurant.getUser().getEmail())")
    public ResponseEntity<CouponDTO> getCoupon(@ModelAttribute("currentUser") User user, @ModelAttribute("restaurant") Restaurant restaurant, @PathVariable Long restaurantId, @PathVariable String id) {
    ...
    @PostMapping
    @PreAuthorize("@resourceGuard.checkOwnership(#user, #restaurant.getUser().getEmail())")
    public ResponseEntity<CouponDTO> createCoupon(@ModelAttribute("currentUser") User user, @ModelAttribute("restaurant") Restaurant restaurant, @RequestBody CouponModel couponModel) {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("@resourceGuard.checkOwnership(#user, #restaurant.getUser().getEmail())")
    public ResponseEntity<CouponDTO> updateCoupon(@ModelAttribute("currentUser") User user, @ModelAttribute("restaurant") Restaurant restaurant, @PathVariable Long restaurantId, @PathVariable String id, @RequestBody Coupon coupon) {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("@resourceGuard.checkOwnership(#user, #restaurant.getUser().getEmail())")
    public ResponseEntity<HashMap<String, String>> deleteCoupon(@ModelAttribute("currentUser") User user, @ModelAttribute("restaurant") Restaurant restaurant, @PathVariable String id) {
